...
public final class ConvertOfficeToSpaceService implements IConvertOfficeToSpaceService {
    ...
    private final String m132511a(String str) {
        ...
        Http_Request_rn_ aVar = new Http_Request_rn_(HttpMethod.POST, "https://" + a + f88306d);
        aVar.set_POST_request_body_rn_(new RequestBody("application/json", ""));
        aVar.set_http_parameters_rn_(new HttpParams(f88307e, String.valueOf(a2)));
        String str2 = f88309g;
        ...
        aVar.set_http_headers_rn_(new HttpHeaders(str2, sb.toString()));
