...
public class C65248c {
    ...
    public static void m256138a(String str, List<? extends SessionInfo> list) {
        ...
        String a = URL_Domain_Parser_rn_.get_top_private_domain_from_URL_rn_(format);
        ...
        Cookie_Details_Container_rn_ d = aVar.mo92519d();
        ArrayList arrayList = new ArrayList();
        arrayList.add(d);
        for (SessionInfo sessionInfo : list) {
            if (!TextUtils.isEmpty(sessionInfo.getHostUrl())) {
                Cookie_Details_Container_rn_.C26015a aVar2 = new Cookie_Details_Container_rn_.C26015a();
